---
name: taskstobeads
description: convert tasks from an OpenSpec change to beads, so they can be implemented one by one with status updates.
license: MIT
---

Convert tasks from an OpenSpec change to beads.
